...
public class AIAssistantProgram
{
    public static void main(String[] args) 
    {
        ...
        try 
        {
            ...
            new UserProfile(null, 25, null, false);
        } 
        ...
        try 
        {
            System.out.println("Test #2: Negative Age");
            new UserProfile("Abby", -23, null, false);
        } 
        catch (IllegalArgumentException e) 
        {
            System.out.println(e.getMessage());
        ...
        try 
        {
            System.out.println("Test #3: InputText Null");
            new Request(null, LocalDateTime.now(), CommandType.MUSIC);
        } 
        catch (IllegalArgumentException e) 
        {
            System.out.println(e.getMessage());
        ...
        try 
        {
            System.out.println("Test #4: Timestamp Null");
            new Request("Give me a song", null, CommandType.MUSIC);
        } 
        catch (IllegalArgumentException e) 
        {
            System.out.println(e.getMessage());
        ...
        try 
        {
            System.out.println("Test #5: CommandType Null");
            new Request("Give me a workout", LocalDateTime.now(), null);
        } 
        catch (IllegalArgumentException e) 
        {
            System.out.println(e.getMessage());
        ...
        try 
        {
            System.out.println("Test #6: Empty Response");
            new Response(null, 0, false);
        } 
        catch (IllegalArgumentException e) 
        {
            System.out.println(e.getMessage());
        ...
        try 
        {
            System.out.println("Test #7: Invalid Confidence Level");
            new Response("Generating", 10f, false);
        } 
        catch (IllegalArgumentException e) 
        {
            System.out.println(e.getMessage());
